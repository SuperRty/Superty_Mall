...
from Superty_mall.utils import constants
from Superty_mall.utils.response_code import RETCODE
# from verifications.libs.yuntongxun.ccp_sms import CCP
from celery_tasks.sms.tasks import send_email_sms
...
class SMSCodeView(View):
    ...
    def get(self, request, mobile):
        ...
        # 发送短信验证码
        # CCP().sendTemplateSMS(mobile, [sms_code, constants.SMS_CODE_REDIS_EXPIRES // 60], constants.SEND_SMS_TEMPLATE_ID)
        # 使用celery发送验证码
        # send_sms_code(mobile, send_sms_code) # 错误的写法
        send_email_sms.delay(mobile, sms_code)  #
